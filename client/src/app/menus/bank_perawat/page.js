...
const BankPerawat = () => {
    return (
        <div className='container' style={{ marginTop: 100 }}>
            <RowColumn imgH1={100} imgH2={100} imgW1={100} imgW2={100} colAlt1={`Form Pengajuan Bank Perawat`} colAlt2={`Daftar Pengajuan`} labelCol1={`Form Pengajuan Bank Perawat`} labelCol2={`Daftar Pengajuan`} imgCol1={`/assets/hero.jpg`} imgCol2={`/assets/hero.jpg`} urlCol1={`https://docs.google.com/forms/d/e/1FAIpQLSe-zJ8-kTJAelqZnr3trmVipnUYetPJrgnVLMhV9QVci8fNPw/viewform`} urlCol2={`https://docs.google.com/spreadsheets/d/1lbuJQZM92TwryZ8FIO925n9uyDQUIsxb1eXuk00lrsc/`} />
            <Link href={`/`} >
