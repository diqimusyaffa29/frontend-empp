        ...
        <div>
            ...
            <div className="container mb-1 pb-2">
                <div className="row gap-4 mt-3 ">
                    ...
                    <div className="col">
                        <BulletList title={`Read`} isi1={`Buka Lembar Laporan Kerja MPP pada halaman Awal`} isi2={`Ganti Tanggal untuk melihat laporan`} />
                    </div>
                </div>
                <div className="row gap-4 mt-5">
                    <div className="col">
                        <BulletList title={`Update`} isi1={`Klik pada link edit pada spreadsheet Hasil Supervisi MPP`} />
                    </div>
                    <div className="col">
